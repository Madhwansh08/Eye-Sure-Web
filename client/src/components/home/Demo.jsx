      ...
      <div className="flex flex-col border-b border-gray-200 lg:border-0">
        <div className="relative">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:grid lg:grid-cols-2 lg:px-8">
              <div className="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                <div className="lg:pr-16 lg:mr-12">
                  <h1 className="text-4xl font-bold tracking-tight text-[#fdfdfd] sm:text-5xl xl:text-6xl">
                    Revolutionizing Healthcare with EyeSure
                  </h1>
                  <p className="mt-4 text-xl pt-4 dark:text-gray-400 text-gray-600">
                  ...
                  <div className="mt-8">
                    <button
                      ...
                      className="inline-block rounded-md border border-transparent bg-secondary px-8 py-3 font-medium text-white hover:bg-[#ffc5ae]"
                    >
                      Watch Full Demo
                    </button>
                  </div>
          ...
          <div className="relative h-48 w-full rounded-t-lg sm:h-64 lg:absolute lg:right-0 lg:top-0 lg:h-full lg:w-1/2">
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#c5865c]/30 to-transparent pointer-events-none"></div>
