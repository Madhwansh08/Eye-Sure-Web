...
const Card = ({ title, subtitle, Icon, number }) => {
  return (
    <button className="w-full p-4 rounded border-[1px] border-slate-300 relative overflow-hidden group bg-white">
      ...
      <div className="relative z-10">
        ...
        <h3 className="font-medium text-lg text-[#030811] group-hover:text-white duration-300">
          {title}
        </h3>
